    ...
    <div className="min-h-screen bg-gradient-to-br from-admin-bg-primary via-admin-bg-secondary to-admin-bg-tertiary flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-block p-3 bg-admin-accent-purple/10 rounded-full mb-4">
            <UserPlus className="w-12 h-12 text-admin-accent-purple" />
          </div>
          <h1 className="text-3xl font-heading font-bold text-admin-text-primary mb-2">
            Create Account
          </h1>
          <p className="text-admin-text-secondary">
            Office of the Vice President — Admin Registration
          </p>
        </div>
        ...
        <div className="bg-admin-bg-secondary border border-admin-border rounded-admin-lg shadow-admin-xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-admin-bg-tertiary border border-admin-border rounded-admin-md text-admin-text-primary placeholder-admin-text-secondary focus:outline-none focus:ring-2 focus:ring-admin-accent-purple focus:border-transparent transition-all"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-admin-text-primary mb-2">
                Confirm Password
              </label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-admin-text-secondary" />
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 px-6 bg-gradient-to-r from-admin-accent-purple to-purple-600 text-white font-semibold rounded-admin-md hover:shadow-admin-glow transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
          ...
          <div className="mt-6 text-center text-sm text-admin-text-secondary">
            ...
            <Link to="/admin/login" className="text-admin-accent-purple hover:underline">
              Sign In
            </Link>
          </div>
        </div>
